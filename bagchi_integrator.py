...
Original file is located at
    https://colab.research.google.com/drive/1go0WUR3pELVfxMaZQgzmCpTcoUuvZ5Lr
"""

import numpy as np
import matplotlib.pyplot as plt

# ---------------- Bagchi (odd–even) integrator ----------------
def bagchi_step(Omega, Delta, eps):
    N = Omega.shape[0]
    for parity in (0, 1):  # even then odd (or vice versa)
        new = Omega.copy()
        for j in range(parity, N, 2):
            ...
            phi = Bnorm * eps
            Oj = Omega[j]
            # Rodrigues rotation matching Sdot = S × B
...
for Delta in deltas:
    ...
    # dashed blue threshold line WITH legend entry
